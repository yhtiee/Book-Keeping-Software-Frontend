            ...
            <Box sx={{
              ...
              <form onSubmit={handelSubmit}>
                ...
                >
                  ...
                  <TextField required type="number" id="outlined-basic" label="Quantity Sold" variant="outlined" color='secondary' />
                  <TextField required type="number" id="outlined-basic" label="Price" variant="outlined" color='secondary' />
                  <TextField required type="number" id="outlined-basic" label="Selling Price" variant="outlined" color='secondary' />
                  <Button
                    sx={{
